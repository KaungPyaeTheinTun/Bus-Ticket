...
<script>
    function printVoucher() {
        const name = document.querySelector('#receiptModal .receipt-content p:nth-child(1) span').textContent;
        const phone = document.querySelector('#receiptModal .receipt-content p:nth-child(2) span').textContent;
